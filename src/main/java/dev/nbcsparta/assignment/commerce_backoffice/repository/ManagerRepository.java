...
public interface ManagerRepository extends JpaRepository<Manager, Long> {
    ...
    //@Query("""
    //        SELECT new dev.nbcsparta.assignment.commerce_backoffice.dto.dashboard.data.ManagerDashboard(
    //        COUNT(m), SUM(CASE WHEN m.status = dev.nbcsparta.assignment.commerce_backoffice.enumerate.AccountStatus.ACTIVE THEN 1 ELSE 0) AS sum FROM Manager m""")
