...
public class CustomerService {
    ...
    public CustomerResponse.ListCustomerResponse findAllCustomer(
            String keyword, Pageable pageable, AccountStatus status
    ) {
        Page<Customer> customerPage = customerRepository.findAllByNameContainingAndStatus(keyword, pageable, status);
